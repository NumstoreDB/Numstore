...
struct ns_write_params
{
  ...
  sb_size stride; ///< Bytes to advance between successive element writes (1 =
                  ///< contiguous)
...
struct ns_read_params
{
  ...
  sb_size stride; ///< Bytes to advance between successive element reads (1 =
                  ///< contiguous)
...
/// Inserts elements into an R+Tree; returns bytes inserted or a negative error
/// code
sb_size ns_insert (struct ns_insert_params *params, error *e);

/// Overwrites elements in an R+Tree; returns bytes written or a negative error
/// code
...
/// Removes elements from an R+Tree; returns bytes removed or a negative error
/// code
...
/// Propagates structural updates bottom-up through the inner nodes of the
/// R+Tree
