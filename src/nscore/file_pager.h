...
/**
 * @file
 * @brief A File pager reads and writes pages to disk
 *
 * As opposed to the pager, the file pager is a dumb pager
 * it just reads and writes data directly to the disk
 */
...
#include "core/stdtypes.h" // u32

/******************************************************************************
 * SECTION: File Pager
 * ----------------------------------------------------------------------------
 * @brief concrete os_pager backed by a single OS file
 *
