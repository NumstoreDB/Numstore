...
/**
 * @file
 * @brief An open address robin hood hash table
 *
 * You must define KTYPE VTYPE and SUFFIX before including
 * this file (all default to int)
 *
 * KTYPE: The type used for keying into the hash table
 * VTYPE: The type that you're storying in the table
 ...
 *
 * Bases hash table on the distance to the iniitial bucket (dib)
 ******************************************************************************/
