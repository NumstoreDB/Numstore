 ...
 *
 * Logging is configured at compile time with levels:
...
#include "platform.h" // PRINTF_ATTR
...
#  define i_log_printf_trace(...) fprintf (stdout, __VA_ARGS__);
#else
...
#  define i_log_printf_debug(...) fprintf (stdout, __VA_ARGS__)
#else
...
#  define i_log_printf_info(...) fprintf (stdout, __VA_ARGS__)
#else
...
#  define i_log_printf_warn(...) fprintf (stdout, __VA_ARGS__)
#else
...
#  define i_log_printf_error(...) fprintf (stdout, __VA_ARGS__)
#else
