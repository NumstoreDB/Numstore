```
smfile_begin(N)            Begin a New Transaction            smfile_begin(N)
```

## NAME

```
   smfile_begin, smfile_commit, smfile_rollback - begin, commit or rollback a transaction 
   to make a series of actions atomic
```
